        ...
        <div className="col-lg-5 pl-lg-5 pb-3 py-lg-5">
          <form onSubmit={handleSubmit}>
            <div className="form-group">
              ...
              <CSSTransition in={state.username.hasErrors} timeout={330} classNames="lifeValidateMessage" unmountOnExit>
            ...
            <div className="form-group">
              ...
              <CSSTransition in={state.email.hasErrors} timeout={330} classNames="lifeValidateMessage" unmountOnExit>
            ...
            <div className="form-group">
              ...
              <input onChange={e => dispatch({ type: "passwordImmedietaly", value: e.target.value })} id="password-register" name="password" className="form-control" type="password" placeholder="Create a password" />
              <CSSTransition in={state.password.hasErrors} timeout={330} classNames="lifeValidateMessage" unmountOnExit>
